...
{
  std::string path_train = "../experiments/iwls2020/benchmarks/momnist/train0vDC.txt";
  std::string path_test = "../experiments/iwls2020/benchmarks/momnist/test0vDC.txt";
  ...
  std::string output_path = "../experiments/iwls2020/results/MNIST/";
   ...
   std::cout << Dl.nin << " " << Dl.nout << " " << Dl.ndata << std::endl;
    ...
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Y, 17 );
    }
    ...
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Y, 25 );
    }
    ...
    {
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 0 );
    }
    else if( iwls2020_ps.dec_algo == "DK_SD" )
    {
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 1 );
    }
    else if( iwls2020_ps.dec_algo == "DK_TSD" )
    {
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 2 );
    }
    else if( iwls2020_ps.dec_algo == "DK_XTSD" )
    {
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 3 );
    }
    else if( iwls2020_ps.dec_algo == "DK_RDSD" )
    {
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 5 );
    }
    else if( iwls2020_ps.dec_algo == "MUESLI" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 9 );
    }
    else if( iwls2020_ps.dec_algo == "AR_MUESLI" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 10 );
    }
    else if( iwls2020_ps.dec_algo == "VOTER3" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 11 );
    }
    else if( iwls2020_ps.dec_algo == "AR3_MUESLI" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 12 );
    }
    else if( iwls2020_ps.dec_algo == "VOTER5" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 13 );
    }
    else if( iwls2020_ps.dec_algo == "AR5_MUESLI" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 14 );
    }
    else if( iwls2020_ps.dec_algo == "chj+ar" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 500 );
    }
    else if( iwls2020_ps.dec_algo == "chjF" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 501 );
    }
    else if( iwls2020_ps.dec_algo == "lgn_64x15" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 1000 );
    }
    else if( iwls2020_ps.dec_algo == "lgn2_64x15" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 1001 );
    }
    else if( iwls2020_ps.dec_algo == "arlgn_64x15" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 1002 );
    }
    else if( iwls2020_ps.dec_algo == "arlgn_8x1024x5" )
    {
      auto Y = std::vector{Dl.Y};
      xag = flow_hdp<xag_network>( Dl.X, Dl.Y, 1003 );
    }
