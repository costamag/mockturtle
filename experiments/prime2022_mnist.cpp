...
void thread_run( iwls2020_parameters const& iwls2020_ps)
{
  ...
  std::string path_valid = "../experiments/iwls2020/benchmarks/mnist/mnist_valid.txt";
  ...
  //              benchmark, aig.num_gates(), d.depth(), la, ta, va, to_seconds(res._cnt.time_dec) );
    fmt::print( "[i] obtained new result on mnist: \n.g {}\n.d {} \n.l {} \n.t {} \n.c {}", 
             aig.num_gates(), d.depth(), la, ta,to_seconds(time_dec)  );

    write_aiger( aig, output_path +"mnist"+iwls2020_ps.dec_algo+".aig" );

    std::ofstream myfile;
    myfile.open ( (output_path +"mnist"+iwls2020_ps.dec_algo+".txt") ); 
