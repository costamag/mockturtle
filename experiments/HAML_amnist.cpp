...
void thread_run( iwls2020_parameters const& iwls2020_ps )
{
  ...
  std::string path_train = "../experiments/iwls2020/benchmarks/mnista/mnist_train.txt";
  std::string path_valid = "../experiments/iwls2020/benchmarks/mnista/mnist_valid.txt";
  std::string path_test = "../experiments/iwls2020/benchmarks/mnista/mnist_test.txt";
  ...
  std::string output_path = "../experiments/iwls2020/results/MNIST/";
   ...
   std::cout << Dl.nin << " " << Dl.nout << " " << Dl.ndata << std::endl;
    ...
    project_ps.max_sup   = iwls2020_ps.max_sup;
    xag = flow_hdp<xag_network>( Dl.X, Y, iwls2020_ps.Id, project_ps );
...
int main( int argc, char* argv[] )
{
  ...
  if( argc == 1 )
    ...
    iwls2020_ps.Id = atoi(argv[1]);
  else if( argc == 3 )
  {
    iwls2020_ps.nImpurity = atoi(argv[1]);
    iwls2020_ps.max_sup   = atoi(argv[2]);
  }
