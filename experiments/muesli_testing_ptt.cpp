...
#include <mockturtle/algorithms/graph_to_lfe_ptt.hpp>
#include <typeinfo>
...
for (uint32_t i = 0 ; i<bvect.size(); i++) {
  ...
  std::string path = "/home/acostama/projects/EPFL/mockturtle/benchmarks/NPN-representatives/nin3/ex"+str_code+".truth";
